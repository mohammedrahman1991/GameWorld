...
### Last Session
Now fix the oversized picker — with 12 buttons it needs more space. Shrink the button width and use 6-per-row:. Done. Here's what changed:

**Legendary tier** (new)
- `★ LEGENDARY` prefix — orange color scheme
- Stats: 1.25× damage, 1.25× mag, 0.87× fire rate (between normal and Mythic)
- **500 coins** each
...
_Last updated: 2026-04-01T08:59:26.686Z | Tokens: 155/800_
<!-- CORTEX:END -->
